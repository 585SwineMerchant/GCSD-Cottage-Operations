...
5. Under **Menu & production**, choose the approved recipe from the **Cottage master menu**, enter the required production quantity, and add it to the event. The approved recipe version is pinned automatically.
